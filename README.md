...
As we have mentioned previousely, a Docker file was created and released in the official [Docker repository](https://github.com/wevertonsc/hadoop-standalone)
